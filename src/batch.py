...
def custom(UCDAVIS=True):
    params = specs.ODict()
    # # long-range inputs
    # params[('weightLong', 'TPO')] = [0.5, 0.5, 0.5]
    # params[('weightLong', 'TVL')] = [0.5, 0.5, 0.5]
    # params[('weightLong', 'S1')] = [0.5, 0.5, 0.5]
    # params[('weightLong', 'S2')] = [0.5, 0.5, 0.5]
    # params[('weightLong', 'cM1')] = [0.5, 0.5, 0.5]
    # params[('weightLong', 'M2')] = [0.5, 0.5, 0.5]
    # params[('weightLong', 'OC')] = [0.5, 0.5, 0.5]

    # EEgain
    params['EEGain'] = [0.5, 0.75, 1.0]
    ...
    # IEgain
    ## L2/3+4
    params[('IEweights', 0)] = [0.5, 1.0, 1.25]
    ## L5
    params[('IEweights', 1)] = [0.5, 1.0, 1.25]
    ## L6
    params[('IEweights', 2)] = [0.5, 1.0, 1.25]

    # IIGain
    ## L2/3+4
    params[('IIweights', 0)] = [0.5, 0.75, 1.0]
    ## L5
    params[('IIweights', 1)] = [0.5, 0.75, 1.0]
    ## L6
    params[('IIweights', 2)] = [0.5, 0.75, 1.0]
    ...
    b = Batch(params=params, netParamsFile='netParams.py', cfgFile='cfg.py',
              initCfg=initCfg)  # , groupedParams=groupedParams)
    b.method = 'grid'
...
def weightNormE(pops=['PT5B'], secs=None, locs=None,
    ...
    b = Batch(params=params, netParamsFile='sim_cell/netParams_cell.py', cfgFile='sim_cell/cfg_cell.py',
              initCfg=initCfg, groupedParams=groupedParams)
...
def setRunCfg(b, type='mpi_bulletin', nodes=1, coresPerNode=8):
    if type == 'mpi_bulletin':
        ...
        b.runCfg = {'type': 'hpc_slurm',
                    ...
                    'email': 'salvadordura@gmail.com',
                    'folder': '/home/ext_salvadordura_gmail_com/m1_paper2019_py3/sim/',
                    # '/home/salvadord/m1/sim/',  # comet,gcp='/salvadord', bridges='/salvi82'
                    'script': 'init.py',
...
if __name__ == '__main__':
    ...
    b.batchLabel = 'grid_M1_UCDavis_batch4'
