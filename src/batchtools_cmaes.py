...
params = {'weightLong.TPO': [0.2, 0.3],
          ...
          'EEGain': [0.4, 0.5],
          'IEweights.0': [0.3, 0.5],  ## L2/3+4
          'IEweights.1': [0.5, 0.6],  ## L5
          'IEweights.2': [0.3, 0.5],  ## L6
          'IIweights.0': [1.6, 2.0],  ## L2/3+4
          'IIweights.1': [1.6, 2.0],  ## L5
          'IIweights.2': [1.6, 2.0],  ## L6
          }

param_space_samplers = [ 'float' for _ in params]
...
results = cmaes_search(
    ...
    num_trials=40, num_workers=40, # change the number of trials and concurrency here
    ...
    output_path=expand_path('../cmaes_search', create_dirs=True)
)
